  ...
  private mockData = [
    {
      ...
      snippets: [
        {
          title: "Greet Function.py",
          code: 'def greet(name): return f"Hello, {name}"',
        },
        {
          title: "Debounce.js",
          code: "function debounce(fn, t) { let timer; ... }",
        },
      ],
    },
    {
      ...
      snippets: [
        {
          title: "Log Wrapper.ts",
          code: "export const log = (msg: string) => console.log(msg);",
        },
      ],
    },
  ];
